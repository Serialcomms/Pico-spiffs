...
u8_t PICO_RAM_ONLY_ALIGNED_DATA spiffs_fds[32*4];
u8_t PICO_RAM_ONLY_ALIGNED_DATA spiffs_work_buf[LOG_PAGE_SIZE*4];
u8_t PICO_RAM_ONLY_ALIGNED_DATA spiffs_cache_buf[(LOG_PAGE_SIZE+32)*32];
