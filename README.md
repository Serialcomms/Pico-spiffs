...
Please note that is not in any way a full or even partial SPIFFS re-write, and that far more source and testing code has been 
removed than added. 
...
Please also note that this repo is still a work in progress, and further updates will be made to it. A 'finished' statement will placed here when development and testing are complete.
